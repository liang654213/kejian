...
let kejianrouter = new Router({
  routes: [{
    ...
    },
    {
      path: '/que-factory',
      name: 'que-factory',
      component: () => import('./views/QueFactory.vue')
    },
    {
      path: '/que-factory-test',
      name: 'que-factory-test',
      component: () => import('./views/QueFactory.vue')
    },
    {
      path: '/que-index',
      name: 'que-index',
      component: () => import('./views/QueIndex.vue')
    },
    {
      path: '/user-home',
      name: 'userhome',
    ...
    },
    {
      path: '/seevedio',
      name: 'seevedio',
      component: () => import('./views/SeeVedio.vue')
    },
    {
      path: '/mainindex',
      name: 'mainindex',
    ...
    },
    {
      path: '/vrhome',
      name: 'vrhome',
      component: () => import('./views/VrHome.vue')
    },
    {
      path: '/admin',
      name: 'admin',
